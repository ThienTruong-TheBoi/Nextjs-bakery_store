                         ...
                         <div className="header__notify">
                            ...
                            <ul className="header__notify-list">
                                <li className="header__notify-item header__notify-item--unview">
                                    <Link href="/noti/id01" className="header__notify-link">
                                ...
                                <li className="header__notify-item">
                                    <Link href="/noti/id02" className="header__notify-link">
                                        <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcRZv1FhlNLdfT5O8Lwir5UzCdyGrK1RsDxw&amp;usqp=CAU" width={48} height={48} alt="BANH SINH NHAT" className="header__notify-img"/>
                                        <div className="header__notify-info">
                                            <span className="header__notify-name">
                                               Bánh sinh nhật
                       ...
                       <li className="header__navbar-item header__navbar-user">
                           ...
                           <ul className="header__navbar-user-menu">
                              <li className="header__navbar-user-item">
                                  <Link href="/buyer/info"> Tài khoản của tôi </Link>
                              </li>
                              <li className="header__navbar-user-item">
                                 <Link href="/buyer/cart"> Giỏ hàng </Link>
                              </li>
                            ...
                            <div className="header__cart-list ">
                                ...
                                <ul className="header__cart-list-item">
                                    ...
                                    <li className="header__cart-item">
                                        <Image src="https://banhmigachdo.com/storage/2023/01/813090157f673a4acd32f1b601d60792.jpg" width={500} height={300} alt="banh mi" className="header__cart-img"/>
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name"> Bánh Mì Dưa Hấu Lá Dứa 600Gr Chuẩn Healthy </h5>
                                    ...
                                    <li className="header__cart-item">
                                        <Image src="https://banhmigachdo.com/storage/2023/01/89672c74c92dad8fc0f8415ead765530.jpg" width={500} height={300} alt="banh mi" className="header__cart-img"/>
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name"> Bánh Cake Carrot 300Gr Chuẩn Vị Anh Dành Cho Ăn Kiêng </h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price"> 68.000đ </span>
                                                    <span className="header__cart-item-multiply"> x </span>
                                                    <span className="header__cart-item-qnt"> 2 </span>
                                                </div>
                                ...
                                <Link href="/buyer/cart" className="header__cart-view-cart btn btn--primary"> Xem giỏ hàng </Link>
