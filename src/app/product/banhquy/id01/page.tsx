                        ...
                        <div className="product-wrap">
                             ...
                             <div className="product_info">
                                ...
                                <div className="product-item__img">
                                    <Image src="https://banhmigachdo.com/storage/2023/01/8c2f7cbc15e61dfb735cd233206cfcf0-500x500.jpeg" width={350} height={350} alt="banh mi" className="product-img"/>
                                </div>

                                <div className="product-detail">
                                    <h3 className="product_title">
                                    Combo Brownie Crackers 250Gr Và Bánh Ngói Hạnh Nhân 250gr Dành Cho Ăn Eatlean
                                    </h3>

                                    <div className="product-item__price">
                                        <span className="product-item__price-old"> 248.000đ </span>
                                        <span className="product-item__price-cur"> 210.000đ </span>
                                    </div>
