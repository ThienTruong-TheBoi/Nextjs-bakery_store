                        ...
                        <div className="product-wrap">
                             ...
                             <div className="product_info">
                                ...
                                <div className="product-item__img">
                                    <Image src="https://banhmigachdo.com/storage/2023/01/52f23bd52d18a90d9ad91053b6cec72f.jpg" width={350} height={350} alt="banh mi" className="product-img"/>
                                </div>

                                <div className="product-detail">
                                    <h3 className="product_title">
                                    Granola Siêu Hạt Mix 11 Quả Hạt 100G, Ngũ Cốc Giảm Cân Chuẩn Ăn Kiêng
                                    </h3>

                                    <div className="product-item__price">
                                        <span className="product-item__price-old"> 40.000đ </span>
                                        <span className="product-item__price-cur"> 29.000đ </span>
                                    </div>
