                        ...
                        <div className="product-wrap">
                             ...
                             <div className="product_info">
                                ...
                                <div className="product-item__img">
                                    <Image src="https://banhmigachdo.com/storage/2023/01/8e1ac8d28a9141fbf864c29236825c32.jpg" width={350} height={350} alt="banh mi" className="product-img"/>
                                </div>

                                <div className="product-detail">
                                    <h3 className="product_title">
                                    Granola Siêu Hạt Mix 11 Loại Hạt 500G, Ngũ Cốc Giảm Cân Chuẩn Ăn Kiêng
                                    </h3>

                                    <div className="product-item__price">
                                        <span className="product-item__price-old"> 200.000đ </span>
                                        <span className="product-item__price-cur"> 140.000đ </span>
                                    </div>
